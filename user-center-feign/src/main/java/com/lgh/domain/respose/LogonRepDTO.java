...
public class LogonRepDTO {
     ...
     * 用户访问的后台资源
     */
    private List<ResourceDomain> userResources;

    private List<MenuDomain> userMenus;
    ...
    public List<ResourceDomain> getUserResources() {
        return userResources;
    }

    public void setUserResources(List<ResourceDomain> userResources) {
        this.userResources = userResources;
    }

    public List<MenuDomain> getUserMenus() {
        return userMenus;
    }

    public void setUserMenus(List<MenuDomain> userMenus) {
